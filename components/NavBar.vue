        ...
        <modal name="prefs" :width="320" height="auto" :scrollable="true">
            <div class="modal-inner">
                ...
                <ul class="switch-list">
                    ...
                    <li class="switch-list-item">
                        <label class="switch-list-label" for="toggle-spotify">
                            <img src="/images/podcatchers/icon-spotify.svg" class="switch-app-icon" />
                            <span>Spotify</span>
                        </label>
                        <input class="toggle-checkbox" type="checkbox" id="toggle-spotify" v-model="$store.state.spotifyVisible" :value="true">
                        <label class="toggle-switch" for="toggle-spotify"></label>
                    </li>
                    <li class="switch-list-item">
...
export default {
    name: 'NavBar',
    components: { IconLogo, IconGear, SearchBar },
    computed: {
        visibility: {
            get () {
