<template>
  <div class="show-subscribe">
    ...
    <div class="show-buttons">
      <a class="show-link" target="_blank" rel="noopener" :href="`https://itunes.apple.com/podcast/id${iTunesID}?mt=2&ct=podlink`" data-ga-category="App Subscribe" data-ga-action="Apple" v-tooltip="`Apple Podcasts`"><img class="app-img" alt="Apple Podcasts" src="/images/podcatchers/icon-itunes.svg" /></a>
      ...
      <a class="show-link" target="_blank" rel="noopener" :href="`https://pca.st/itunes/${iTunesID}`" data-ga-category="App Subscribe" data-ga-action="Pocket" v-tooltip="`Pocket`"><img class="app-img" alt="Pocket Casts" src="/images/podcatchers/icon-pocketcasts.svg" /></a>
